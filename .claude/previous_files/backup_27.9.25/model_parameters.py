...
# PARÂMETROS ORIGINAIS (BACKUP)
ORIGINAL_PARAMS = {
    "language": "pt",  # Fixo PT-BR
    "task": "transcribe",
    "fp16": True,  # Se CUDA disponível
    "verbose": False,
    "beam_size": 1,
    "best_of": 1,
    "temperature": 0.0,
...
def get_optimized_params(use_phase1: bool = True) -> dict:
    """
    Retorna parâmetros otimizados para PT-BR
    ...
    # Usar parâmetros FASE 1 otimizados para PT-BR
    base_params = {
        "language": "pt",  # Fixo PT-BR
        "task": "transcribe",
        "fp16": True,  # Será ajustado dinamicamente
        "verbose": False,
        "prepend_punctuations": "",
        "append_punctuations": "",
    }
