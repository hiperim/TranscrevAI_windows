...
# INT8ModelConverter removed with ONNX cleanup - models.py removed (unused)
...
class CompleteAppState:
    ...
    def __init__(self):
        ...
        # INT8ModelConverter removed with ONNX - models.py removed (unused)
        # Model management now handled by dual_whisper_system.py directly
