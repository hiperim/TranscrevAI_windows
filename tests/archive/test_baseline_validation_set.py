# tests/test_baseline_validation_set.py
"""
Baseline Test - VALIDATION SET ONLY (t.speakers.wav, t2.speakers.wav)

⚠️  CRITICAL: This test uses RESERVED validation files.
DO NOT USE during development or rule creation.
ONLY run this for FINAL validation after all improvements are complete.

Purpose:
- Final unbiased validation of improvements
- Measure true generalization performance
- Prevent overfitting to training set

Validation Set:
- t.speakers.wav: 3 speakers, difficult audio
- t2.speakers.wav: 3 speakers, difficult audio

Training Set (used for development):
- d.speakers.wav
- q.speakers.wav
"""
...
# VALIDATION SET ONLY - t and t2 files
...
async def test_baseline_validation_set():
    """Testa baseline ULTRA ACCURACY em VALIDATION SET (t, t2 apenas)."""

    print("\n" + "="*70)
    print("⚠️  VALIDATION SET TEST - FINAL EVALUATION ONLY")
    print("Model: medium int8 ULTRA ACCURACY")
    print("="*70)
    print("\n⚠️  WARNING: This is the VALIDATION SET")
    print("DO NOT use these results for development or rule tuning!")
    print("")
    print("VALIDATION SET (final test):")
    print("  🔒 t.speakers.wav (3 speakers, difficult)")
    print("  🔒 t2.speakers.wav (3 speakers, difficult)")
    print("\nTRAINING SET (not tested here):")
    print("  ✅ d.speakers.wav")
    print("  ✅ q.speakers.wav")
    print("")
    ...
    print("\n⚠️  Are you sure you want to run validation test?")
    print("This should ONLY be done for final evaluation.")
    print("\nPress Enter to continue, or Ctrl+C to cancel...")
    # Note: In automated testing, we'll skip the input prompt
    # input()
    ...
    for audio_file, truth_data in VALIDATION_GROUND_TRUTH.items():
    ...
    print("\n" + "="*70)
    print("VALIDATION SET RESULTS (FINAL)")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("⚠️  VALIDATION SET - This is final unbiased performance")
    print("Compare with training set to detect overfitting")
    print("="*70)
    ...
    json_path = REPORT_DIR / f"baseline_validation_set_{timestamp}.json"
    json_path.write_text(json.dumps({
        "timestamp": timestamp,
        "dataset": "validation_set",
        "files_included": list(VALIDATION_GROUND_TRUTH.keys()),
        "files_excluded": ["d.speakers.wav", "q.speakers.wav"],
        "config": {
            "model": "medium",
            "compute_type": "int8",
            "vad": {
...
if __name__ == "__main__":
    asyncio.run(test_baseline_validation_set())
